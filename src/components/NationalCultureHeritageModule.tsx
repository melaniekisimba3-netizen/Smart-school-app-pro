  ...
  const [items, setItems] = useState<HeritageItem[]>(() => {
    ...
    return [
      ...
      },
      {
        ...
        mainPhoto: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Laurent-D%C3%A9sir%C3%A9_Kabila_1997.jpg/600px-Laurent-D%C3%A9sir%C3%A9_Kabila_1997.jpg",
        gallery: ["https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Laurent-D%C3%A9sir%C3%A9_Kabila_1997.jpg/600px-Laurent-D%C3%A9sir%C3%A9_Kabila_1997.jpg"],
